                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <a class="btn btn-xs btn-danger waves-effect"
                                href="{{ route($ParentRouteName. '.trashed') }}">{{ __('root.common.trash') }}({{ $count_dv }}
                                )</a>
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{ __('root.dr_voucher.particulars') }}</th>
                                                <th>{{ __('root.dr_voucher.branch_name') }}</th>
                                                <th>{{ __('root.dr_voucher.date') }}</th>
                                                <th>{{ __('root.dr_voucher.head_of_account_name') }}</th>
                                                <th>{{ __('root.dr_voucher.made_of_payment') }}</th>
                                                <th>{{ __('root.dr_voucher.chq_no') }}</th>
                                                <th class="text-right">{{ __('root.dr_voucher.amount') }} ( <?php echo config('settings.is_code') == 'code' ? config('settings.currency_code') : config('settings.currency_symbol'); ?>
                                                    )
                                                </th>
                                                <th class="width-100 text-center">{{ __('root.dr_voucher.options') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $i = 1; ?>
                                            @foreach ($items as $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">{{ $transaction->convert_money_format($amount) }}</td>
